<section>
    ...
    <form method="post" action="{{ route('users.update', $user->id) }}" class="mt-6 space-y-6">
        ...
        <!-- User type -->
        <div class="mt-2 mb-2">
            <x-input-label for="admin" :value="__('Type')" />
            <select id="type_user" name="admin" class="form-control rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full">
